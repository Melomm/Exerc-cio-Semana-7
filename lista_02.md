...
2. Receber a idade inserida.
3. Se a idade for menor que 16:
   3.1. Imprimir "Não pode votar."
4. Senão, se a idade for maior ou igual a 16 e menor que 18:
   4.1. Imprimir "Voto facultativo."
5. Senão:
   5.1. Imprimir "Voto obrigatório."
   ```
...
Resp:
```
1. Nova Classe FormaGeometrica
    1.1. Atributos dela
        1.1.1. cor

    1.2. Método Construtor
        1.2.1. Define o valor do atributo cor com o valor passado como parâmetro.

    1.3. Fazer Método CalcularArea
        1.3.1. Implementação genérica para cálculo de área, a ser sobrescrita pelas subclasses.

2. Classe Retangulo que Herda da FormaGeometrica
    2.1. Atributos adicionais
        2.1.1. base
        2.1.2. altura

    2.2. Método Construtor com os atributos cor, base, altura
        2.2.1. Chama o construtor da classe pai, passando cor como parâmetro.
        2.2.2. Define os valores dos atributos base e altura com os valores passados como parâmetros.

    2.3. Método CalcularArea
        2.3.1. Retorna base vezes altura.

3. Agora Classe Circulo que Herda da FormaGeometrica
    3.1. Atributos adicionais dela
        3.1.1. raio

    3.2. Método Construtor com atributos cor e raio
        3.2.1. Chama o construtor da classe pai, passando cor como parâmetro.
        3.2.2. Define o valor do atributo raio com o valor passado como parâmetro.

    3.3. Método CalcularArea
        3.3.1. Retorna pi vezes raio elevado a 2
```
______
...
Resp:
```
1. Fazer Função SimularCorrida com: distancia, velocidade_inicial, taxa_aceleracao, velocidade_maxima e tempo_maximo
2.     Inicializar velocidade_atual com a velocidade inicial do carro.
3.     Inicializar tempo com 0.
4.     
5.     Enquanto o carro estiver abaixo da velocidade máxima e o tempo de corrida não passar do limite:
6.         Aumentar a velocidade do carro com tempo de acordo com a aceleração.
7.         Aumentar o tempo de corrida em 1 minuto.
8.     
9.     Se o carro atingir ou passar da a velocidade máxima antes de seguir toda a distância:
10.        Calcular o tempo adicional necessário para terminar a distância restante à velocidade máxima.
11.     
12.    Se o tempo total de corrida passar do limite máximo permitido:
13.        Retornar uma mensagem que o carro não conseguiu completar a corrida dentro do tempo máximo.
14.    Senão:
15.        Retornar o tempo total necessário para completar a corrida.
...
Função MultiplicacaoDeMatrizes(matrizA, matrizB):
    ...
    Se tamanho(matrizA[0]) diferente tamanho(matrizB) então:
    ...
    Senão:
        ...
        Para i de 0 até linhasA-1:
            Para j de 0 até colunasB-1:
                elemento <- 0
                Para k de 0 até colunasA-1:  # colunasA == tamanho(matrizB)
